...
const (
	dockerImageName = "jerrywang1981/pdf2image:0.0.1"
)

func ConvertPdfToImage(inputFolder, outputFolder string) error {
	fullFolderName, err := filepath.Abs(inputFolder)
	if err != nil {
		return err
	}
	fullResultFolderName, err := filepath.Abs(outputFolder)
	if err != nil {
		return err
	}
